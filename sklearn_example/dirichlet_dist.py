...
class DirichletDist:
    ...
    def _dirichlet_sample(self, density):
        ...
        dirichlet_sample = stats.dirichlet.rvs(alpha=[density for _ in range(self.num_clients)], size=self.num_classes)
    ...
    def get_dirichlet_noniid_splits(self, density=1):
        ...
        for client in range(self.num_clients):
            ...
            client_dfs[client] = {"target": train_df[self.class_col], "data": train_df.drop([self.class_col], axis=1)}
